...
# ===== CONFIGURATION =====
OPENROUTER_API_KEY = "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"
...
def main():
    ...
    with st.sidebar:
        ...
        theme_options = ["Light Mode", "Dark Mode", "Cyberpunk", "Ocean Blue", "Emerald"]
        ...
        new_voice = st.selectbox(
            "Voice Gender",
            voice_options,
            index=voice_options.index(st.session_state.voice_gender) if st.session_state.voice_gender in voice_options else 0
        )

        # Update voice gender if changed
        if new_voice != st.session_state.voice_gender:
            st.session_state.voice_gender = new_voice
    ...
    """
        ...
        © 2025 SmartAI Virtual Assistant | Developed by Pathri Akhila<br>
        </div>
    """,
